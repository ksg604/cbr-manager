...
@Database(entities = {Alert.class, Client.class, Visit.class, Status.class, User.class, AuthDetail.class, Referral.class, Goal.class}, version = 1, exportSchema = false)
